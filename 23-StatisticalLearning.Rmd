...
```{r echo=FALSE}
knitr::include_graphics("images/predobs.png")
```
...
-   El conjunto de reglas de partición se puede resumir en un árbol.
    ...
    ```{r echo=FALSE}
    knitr::include_graphics("images/arbol1.png")
    ```
...
```{r echo=FALSE}
knitr::include_graphics(c("images/arbol2.png", "images/arbol3.png"))
```
...
-   Se consideran núcleos polinómicos, radiales, ...
    ...
    ```{r echo=FALSE}
    knitr::include_graphics("images/svm4.png")
    ```
