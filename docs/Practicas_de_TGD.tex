...
\item
  Clase 14 (12/12-R): Seminario Aprendizaje Estadístico/Automático, Data
  Mining
\item
  Clase 15 (19/12-opcional): Seminario aplicaciones Big Data en
...
o el Capítulo \href{http://r4ds.had.co.nz/transform.html}{5 Data
transformation} del libro:
...
\href{https://dplyr.tidyverse.org/reference/join.html}{Join two tbls
together}
...
\href{https://dbplyr.tidyverse.org/articles/dbplyr.html}{Introduction to
dbplyr}
...
Descargar Spark de \url{https://spark.apache.org/downloads.html} y
disponer al menos de Java 7
...
Ejecutar pyspark o sparkshell para saber si está correctamente
instalado.
...
datos}\label{creacion-de-la-base-de-datos}
...
DB}\label{primera-ejecucion-creacion-del-modelo-de-db}
