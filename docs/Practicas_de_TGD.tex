...
\includegraphics{images/T3-CientificoDatos.png}

\includegraphics{images/T3-DMvsBD.jpg}

\includegraphics{images/T3-AI-ML.png}
...
\includegraphics{images/T3-Supervised_ML.png}
...
\hypertarget{tecnologuxedas-big-data-hadoop-spark-hive-rspark-sparklyr}{%
\section{Tecnologías Big Data (Hadoop, Spark, Hive, Rspark, Sparklyr)}\label{tecnologuxedas-big-data-hadoop-spark-hive-rspark-sparklyr}}
...
\section{Visualización y Generación de Cuadros de Mando}\label{visualizaciuxf3n-y-generaciuxf3n-de-cuadros-de-mando}}
...
\chapter{Introducción al Aprendizaje Estadístico}\label{introducciuxf3n-al-aprendizaje-estaduxedstico}}
...
\hypertarget{muxe9todos-de-aprendizaje-supervisado}{%
\subsection{Métodos (de aprendizaje supervisado):}\label{muxe9todos-de-aprendizaje-supervisado}}
...
\hypertarget{construcciuxf3n-y-evaluaciuxf3n-de-los-modelos}{%
\subsection{Construcción y evaluación de los modelos}\label{construcciuxf3n-y-evaluaciuxf3n-de-los-modelos}}
...
\hypertarget{arboles-de-decisiuxf3n}{%
...
\hypertarget{bagging-o-agregaciuxf3n-bootstrap}{%
\subsection{Bagging o agregación Bootstrap}\label{bagging-o-agregaciuxf3n-bootstrap}}
