...
\hypertarget{ejemplos-practica-1}{%
...
\hypertarget{metodos-de-aprendizaje-supervisado}{%
\subsection{Métodos (de aprendizaje supervisado):}\label{metodos-de-aprendizaje-supervisado}}
...
\begin{itemize}
\item
  R-Commander + FactoMineR: \texttt{Rcmdr}, \texttt{RcmdrPlugin.FactoMineR}
\item
  Rattle: \texttt{rattle}
\end{itemize}

\hypertarget{construccion-y-evaluacion-de-los-modelos}{%
\subsection{Construcción y evaluación de los modelos}\label{construccion-y-evaluacion-de-los-modelos}}
...
\item
  ...
  pequeño\footnote{El error de estimación suele ser de orden \(n^{-1/2}\) o superior,
...
\item
  ...
  \begin{itemize}
  \item
    Resumir (paralela/distribuida) -\textgreater{} Combinar -\textgreater{} Modelar
  \item
    Modelar (paralela/distribuida) -\textgreater{} Combinar
  \item
    Se puede implementar mediante un sistema \emph{MapReduce} (Hadoop):
    los datos se procesan de forma distribuida mediante \emph{Mappers}
    y los resultados se combinan mediante \emph{Reducers}.
  \end{itemize}
\end{itemize}
