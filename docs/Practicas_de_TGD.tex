...
\NormalTok{CREATE EXTERNAL TABLE IF NOT EXISTS flights}
\NormalTok{(}
\NormalTok{year int,}
\NormalTok{month int,}
...
\NormalTok{LOAD DATA INPATH }\StringTok{'flights'}\NormalTok{ INTO TABLE flights;}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{ejercicio-a-con-sparklyr-y-hadoop}{%
\subsection{Ejercicio A con sparklyr y Hadoop}\label{ejercicio-a-con-sparklyr-y-hadoop}}
