---
title: "Bibliometric impact assessment with the CITAN package"
author: "MTE: Tecnologías de Gestión de Datos"
date: '`r paste("CITAN", packageVersion("CITAN"),":", Sys.Date())`'
output: 
  html_document:
    toc: yes
    toc_depth: 2
...
# knitr::spin("CITAN.R", knit = FALSE)
# knitr::purl("CITAN.Rmd", documentation = 2)
# options(digits = 5)
```
